...
from .views import HomeView, NoteCreateView, NoteDeleteView, NoteDetailView, NoteListView, NoteUpdateView, \
    TripDeleteView, TripDetailView, TripUpdateView, trips_list, TripCreateView
